...
When we launched `npx @fictjs/shadcn create` in December, we introduced the ability to choose between Radix and Base UI as your component library. Today, we're following up with complete documentation for all Base UI components.
...
If you're starting a new project, run `npx @fictjs/shadcn create` and pick your preferred library. The CLI handles the rest.
